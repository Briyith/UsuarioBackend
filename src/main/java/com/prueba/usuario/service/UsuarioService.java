...
import com.prueba.usuario.repository.UsuarioRpository;

@Service
@Transactional
public class UsuarioService implements UsuarioRpository {
	
	//Esta notación permite crear una inyeccion de este elemento.
	@Autowired
	private UsuarioRpository usuarioRpository;
	
	// metodos que extiende de JPARepository
	...
	public <S extends Usuario> S save(S entity) {
		return usuarioRpository.save(entity);
	}
	...
	public boolean existsById(Long id) {
		return usuarioRpository.existsById(id);
	}
	...
	public Optional<Usuario> findByCedula(String cedula) {
		return usuarioRpository.findByCedula(cedula);
	}

	@Override
	public boolean existsByCedula(String cedula) {
		return usuarioRpository.existsByCedula(cedula);
	}
